...
public class IntJoukkoTest {
    ...
    public void vainLisatytLuvutLoytyvat() {
        assertTrue(joukko.alreadyExists(10));
        assertFalse(joukko.alreadyExists(5));
        assertTrue(joukko.alreadyExists(3));
    }

    @Test
    public void poistettuEiOleEnaaJoukossa() {
        joukko.poista(3);
        assertFalse(joukko.alreadyExists(3));
    ...
    public void toimiiKasvatuksenJalkeen(){
        ...
        assertTrue(joukko.alreadyExists(11));
        joukko.poista(11);
        assertFalse(joukko.alreadyExists(11));
